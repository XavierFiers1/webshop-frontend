...
LOADER.setAttribute('class', 'm-auto mdl-spinner mdl-spinner--single-color mdl-js-spinner is-active');
            ...
            if (!orders[0].usersOrder.length) {
                ...
                orders[0].usersOrder.forEach(order => {
                    ...
                    orders[0].usersOrder[0].OrderList.forEach(item => {
                        ...
                        orderItem.innerHTML = `
                            <td class="mdl-data-table__cell--non-numeric">${item.productDetails[0].ProductName}</td>
                            <td>${item.productDetails[0].productCategory[0].CategoryName}</td>
